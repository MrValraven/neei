      ...
      <div class="heroContent">
        <div class="textArea">
          ...
          <div class="buttons">
            ...
            <button v-if="socio" class="socio">Faz-te Sócio!</button>
          </div>
        </div>
    ...
    <section class="features">
      ...
      <div class="feature">
        ...
        <div class="plataformas">
          ...
          <h2>Plataformas</h2>
          <p>Plataformas , base de dados Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam vitae consectetur numquam commodi quasi dicta officiis dignissimos est nisi vero.</p>
        </div>
        <div class="workshops">
          <svg version="1.1" :width="width" :height="height" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
    ...
    <section class="ourWork">
      <div class="work">
        ...
        <div class="text">
          ...
          <div class="events">
            <EventCard titulo="Voz"  descricao="Torna-te uma voz ativa dentro da comunidade! Contamos com toda a ajuda que podemos ter pois projetos e ideias não faltam!">
              <svg version="1.1" :width="width" :height="height" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                  viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
            ...
            <EventCard  class="secondEvent" titulo="Entreajuda"  descricao="Partilhem as vossas dúvidas e ajudem-se, o curso não se faz sozinho">
            ...
            <EventCard  titulo="Ideias"  descricao="Liberta o teu espirito empreendedor e junta-te com os teus colegas para darem vida a um novo projeto">
              <svg version="1.1" :width="width" :height="height" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
